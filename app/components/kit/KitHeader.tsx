...
export default function KitHeader({ repo, role, level }: KitHeaderProps) {
  return (
    <div className="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-6 py-2.5">
      {/* Left: breadcrumb — Day Zero › repo */}
      <div className="flex items-center gap-2 text-sm">
        <span className="font-medium text-gray-400">Day Zero</span>
